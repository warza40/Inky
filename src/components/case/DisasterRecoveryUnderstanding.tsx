...
export function DisasterRecoveryUnderstanding({
  understanding,
}: {
  understanding: U;
}) {
  ...
  return (
    <div className="cs-dr-understanding">
      <section
        className="cs-dr-understanding-section cs-dr-understanding-section--personas"
        aria-labelledby="dr-personas-heading"
      >
        <h3 id="dr-personas-heading" className="cs-context-section-title">
          {sr.title}
        </h3>
      ...
      <section
        className="cs-dr-understanding-section cs-dr-understanding-section--ia"
        aria-labelledby="dr-ia-heading"
      >
        {eyebrow ? (
          <h3 className="cs-context-section-title">{eyebrow}</h3>
        ) : null}
        <h2 id="dr-ia-heading" className="ojo-d-title">
          {headline}
        </h2>
